...
const UpdatedTouristSpot = () => {
    ...
    const handleUpdateTourism = event => {
        ...
        const updateTourism = { photo, seasonality, touristSpot, travelTime, travelTime, countryName, totalVisitorPerYear, location, email, shortDescription, userName, averageCost };
        fetch(`https://tourist-management-server-five.vercel.app/tourism/${_id}`, {
            method: 'PUT',
            headers: {
            ...
            if (data.modifiedCount>0) {
                Swal.fire({
                    title: 'Success!',
                    text: 'Tourist Spot Updated Sucessfully',
                    icon: 'success',
    ...
    return (
        <div>
            ...
            <div className="bg-[#F4F3F0] p-24">
                <h2 className="text-3xl font-extrabold text-center mb-10">Updated a new Tourism Spot:{touristSpot}</h2>
                <form onSubmit={handleUpdateTourism}>
                    ...
                    <div className="md:flex mb-8">
                        <div className="form-control md:w-1/2">
                            ...
                            <label className="input-group">
                                <input type="text" name="touristSpot" defaultValue={touristSpot} placeholder="Tourist Spot Name" className="input input-bordered w-full" />
                            </label>
                        </div>
                        <div className="form-control md:w-1/2 ml-4">
                            <label className="label">
                    ...
                    <div className="md:flex mb-8">
                        <div className="form-control md:w-1/2">
                            ...
                            <select className="select select-bordered" name="countryName" defaultValue={countryName} >
                    ...
                    <input type="submit" value="Updated Turism" className="btn btn-accent w-full" />
...
export default UpdatedTouristSpot;